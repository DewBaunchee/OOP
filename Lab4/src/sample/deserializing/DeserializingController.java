...
public class DeserializingController {
    ...
    public static Legion deserializable;
        ...
        deserializeBtn.setOnAction(actionEvent -> {
            try {
                ...
                try (ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(allBytes)) {
                    ...
                    if (!method.equals("text") && !method.equals("xml")) {
                    ...
                    if (method.equals("text")) {
                        deserializable.readExternal(new ObjectInputStream(new ByteArrayInputStream(objectBytes)));
                    }

                    if(method.equals("xml")) {
                        deserializable.xmlDeserialize(new StringReader(new String(objectBytes)));
                    }
